...
import app_configuration as appConf    #Input File for providing DB details, table name, common string formats
#import app_constants as constant #Importing Constant variables file
import statuswho
...
class staticVar:
    connection = ""
    cursor = ""
    DBConnectionData = {"statusCode":None,"connectionMsg":None,"isDBConnected":False}
...
def insertDataIntoTable(tableName,name,surname,email,password,mobileno,licenseno):
    ...
    try:
        ...
        record_to_insert = (tableName,name,surname,email,password,mobileno,licenseno)
        print (insert_query)
